...
class Message(base):
    ...
    def __init__(self, sender_host, sender_ip, receiver_host, receiver_ip, body):
    ...
    def __repr__(self):
        return "<Message> %s to %s at %s" % (self.sender_host, self.receiver_host, self.created_date)
